    ...
    return (
        ...
        <div className="main-div">
            ...
            <div className="contact-fill">
                ...
                <div className="form-name-row2">
                <div className="Fname">E-mail <input type="text" className="textbook2" placeholder="Enter your Email"></input></div>
                <div className="Fname">Phone  <input type="text" className="textbook2" placeholder="Enter your phone number"></input></div>
                </div>
                ...
                <div className="fname1"><div>Message </div> <div><input type="text"  className="messagebook" placeholder="Enter your message "></input></div></div>
            <div><button placeholder="Send Message" className="send-button"><span>Send </span><FontAwesomeIcon icon={faAngleDoubleRight} /></button></div>
            </div>
        </div>
